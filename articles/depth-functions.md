...
head(depths_rp)
#> [1] 0.06193548 0.08387097 0.21741935 0.27161290 0.26838710 0.27548387
```
...
head(depths_rpd)
#> [1] 0.0980000 0.1073333 0.2006667 0.2160000 0.1973333 0.1840000
```
...
#>        FM mode   RP   RT  FSD
#> FM   1.00 0.98 0.94 0.30 0.98
#> mode 0.98 1.00 0.95 0.25 0.97
#> RP   0.94 0.95 1.00 0.23 0.94
#> RT   0.30 0.25 0.23 1.00 0.35
#> FSD  0.98 0.97 0.94 0.35 1.00
```
