...
head(depths_rp)
#> [1] 0.05483871 0.11483871 0.25419355 0.27419355 0.28000000 0.26322581
```
...
head(depths_rpd)
#> [1] 0.06666667 0.06800000 0.23600000 0.24733333 0.22200000 0.22200000
```
...
#> mode 0.98 1.00 0.94 0.20 0.97
#> RP   0.94 0.94 1.00 0.27 0.96
#> RT   0.23 0.20 0.27 1.00 0.26
#> FSD  0.98 0.97 0.96 0.26 1.00
```
