...
head(depths_rp)
#> [1] 0.04451613 0.10064516 0.28709677 0.31354839 0.22903226 0.25032258
```
...
head(depths_rpd)
#> [1] 0.0960000 0.1300000 0.1793333 0.2186667 0.1920000 0.1933333
```
...
#> RP   0.96 0.93 1.00 0.19 0.96
#> RT   0.21 0.21 0.19 1.00 0.22
#> FSD  0.98 0.97 0.96 0.22 1.00
```
