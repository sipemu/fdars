...
head(depths_rp)
#> [1] 0.05741935 0.08387097 0.25677419 0.32967742 0.25032258 0.27548387
```
...
head(depths_rpd)
#> [1] 0.08133333 0.10666667 0.18133333 0.22200000 0.19333333 0.20466667
```
...
#>        FM mode   RP   RT  FSD
#> FM   1.00 0.98 0.90 0.28 0.98
#> mode 0.98 1.00 0.92 0.22 0.97
#> RP   0.90 0.92 1.00 0.25 0.88
#> RT   0.28 0.22 0.25 1.00 0.30
#> FSD  0.98 0.97 0.88 0.30 1.00
```
