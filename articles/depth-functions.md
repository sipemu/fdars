...
head(depths_rp)
#> [1] 0.04967742 0.07161290 0.26967742 0.28903226 0.30645161 0.27290323
```
...
head(depths_rpd)
#> [1] 0.1026667 0.0900000 0.2013333 0.2126667 0.2093333 0.1746667
```
...
#> RP   0.95 0.94 1.00 0.22 0.97
#> RT   0.18 0.17 0.22 1.00 0.23
#> FSD  0.98 0.97 0.97 0.23 1.00
```
