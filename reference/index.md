...
- [`kernel_add()`](https://sipemu.github.io/fdars/reference/kernel_add.md)
...
- [`kernel_mult()`](https://sipemu.github.io/fdars/reference/kernel_mult.md)
  : Multiply Covariance Functions
- [`kernel_periodic()`](https://sipemu.github.io/fdars/reference/kernel_periodic.md)
  : Periodic Covariance Function
- [`kernel_polynomial()`](https://sipemu.github.io/fdars/reference/kernel_polynomial.md)
  : Polynomial Covariance Function
- [`kernel_whitenoise()`](https://sipemu.github.io/fdars/reference/kernel_whitenoise.md)
