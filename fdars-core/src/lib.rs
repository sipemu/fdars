...
pub use depth::{
    ...
    functional_depth, functional_spatial_1d, functional_spatial_2d, hypograph_index_1d,
    kernel_functional_spatial_1d, kernel_functional_spatial_2d, modal_1d, modal_2d,
    modified_band_1d, modified_epigraph_index_1d, modified_hypograph_index_1d,
