...
pub use additive::{
    ...
    FamConfig, FamResult, GkamConfig, GkamResult, GsamConfig, GsamResult, HistoryIndexConfig,
    HistoryIndexResult, PermTestConfig, PermTestResult, PermTestStatistic, VarSelectConfig,
    VarSelectPenalty, VarSelectResult,
};
pub use bootstrap::{bootstrap_ci_fregre_lm, bootstrap_ci_functional_logistic};
pub use cv::{fregre_basis_cv, fregre_np_cv};
pub use fregre_lm::{
    fregre_cv, fregre_lm, model_selection_ncomp, predict_curve_generic, predict_fregre_lm,
};
