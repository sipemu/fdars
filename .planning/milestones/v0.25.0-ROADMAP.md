...
- [x] **Phase 36: Density Object-Data FDA** - Add the log-quantile-density (LQD) transform + inverse, LQD-FPCA for probability densities (reuse `fdata_to_pc_1d` in LQD space), a 1D Wasserstein Fréchet-mean barycenter, and density normalization/regularization in a new `density_fda.rs` (DENS-01, independent) (completed 2026-08-21)
...
| 36. Density Object-Data FDA | 3/3 | Complete    | 2026-08-21 |
