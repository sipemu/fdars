...
- [x] **Phase 60: Bundled ShapeletTransformClassifier** - End-to-end `fit` (discover → transform → classify; kNN default, LDA optional) + `predict`; crate-root re-exports (SHP-07) (completed 2026-09-02)
...
| 60. Bundled ShapeletTransformClassifier | v0.33.0 | 1/1 | Complete    | 2026-09-02 |
