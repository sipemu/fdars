...
---
*Last updated: 2026-08-09 — Phase 7 (scikit-fda Capability Enumeration) complete: versioned (skfda 0.10.1, runtime-verified), area-organized capability inventory across six areas in AUDIT-REPORT.md §Phase 7, enumerated capability-first (fit/predict/transform collapsed, Pitfall 9 avoided); one-page Design-Goal Filter separates 129 in-scope from 32 out-of-scope (161 total) for Phase 8's parity matrix; zero src edits (GAP-01). Prior: Phase 6 conditional SVD comparison (PERF-06, faer 1.8–4.1× faster, P6-1); Phase 5 parallelism gap assessment (PERF-05); Phase 4 FPCA/SVD & allocation audit (PERF-03/04, Phase-6 GO); Phase 2 static hot-path map (PERF-01); Phase 1 benchmark apparatus + baselines (PERF-02).*
