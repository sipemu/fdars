...
- [ ] 11-01-parallel-cv-folds-PLAN.md — Parallelize `fclassif_cv` fold loop via `iter_maybe_parallel!(0..nfold)` + bit-for-bit sequential-vs-parallel equivalence test (PERF-01, wave 1, independent)
...
| 11. Performance Wins (Parallel CV & faer SVD) | v0.15.0 | 0/2 | Planned | - |
