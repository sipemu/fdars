...
- [ ] **Phase 90: Golden-Flake Root-Cause & Deterministic Fix** - Diagnose why the three golden tests flake under full parallel `cargo test`, then fix them deterministically.
...
|-------|-----------|----------------|--------|-----------|
| 90. Golden-Flake Root-Cause & Deterministic Fix | v0.43.0 | 0/TBD | Not started | - |
