...
- [ ] **Phase 16: R Ecosystem Inventory** - Versioned, area-organized, capability-first inventory of the R FDA ecosystem, then design-goal filtered into in-scope / out-of-scope with per-area counts
...
|-------|-----------|----------------|--------|-----------|
| 16. R Ecosystem Inventory | v0.18.0 | 0/2 | Not started | - |
