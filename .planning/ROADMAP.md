...
- [x] 45-02-slope-heuristic-selection-PLAN.md — Birgé–Massart slope-heuristic (K,L) model selection over a grid (CLUS-02-03)
...
| 45. Functional Co-Clustering (funLBM latent-block) | 2/2 | In Progress|  |
