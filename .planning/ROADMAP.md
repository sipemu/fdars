...
Carried tech debt (non-blocking): 3 advisory code-review items (dead MEWMA assertion, `fix_svd_signs` NaN no-op, over-broad test name); both phase VALIDATION.md files remain `draft` (Nyquist coverage TODO).
...
---
*Latest: v0.15.0 shipped 2026-08-11 — 2 phases, 4/4 requirements, milestone audit passed. Prior: v0.14.0 audit milestone shipped 2026-08-09 (9 phases). Next milestone starts with `/gsd-new-milestone` (fresh REQUIREMENTS.md).*
