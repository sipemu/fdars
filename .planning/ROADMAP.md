...
- [ ] 05-02-PLAN.md — Expansion (SC1): second sentinel (streaming depth_batch) thread sweep + payback-N downward sweep vs RAYON_NUM_THREADS=1; complete thread-scaling table + payback-threshold-N
