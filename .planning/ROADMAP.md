...
- [x] 21-01-PLAN.md — FLM inference: `flm_f_test` (tracer: F-dist SF + end-to-end F-test), then `flm_gof_test` (residual GoF) and `oneway_anova_vstat` (asymptotic V-statistic alongside `fanova`); all crate-root re-exported, additive/non-breaking
