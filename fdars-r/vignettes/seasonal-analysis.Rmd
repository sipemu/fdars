...
class_df <- data.frame(
  ...
  Value = c(class_result$seasonal.strength, stability_score)
)
...
cat("  Stable signal:      ", class_stable$classification,
    "(strength:", round(class_stable$seasonal.strength, 2), ")\n")
cat("  Variable signal:    ", class_variable$classification,
    "(strength:", round(class_variable$seasonal.strength, 2), ")\n")
cat("  Intermittent signal:", class_intermittent$classification,
    "(strength:", round(class_intermittent$seasonal.strength, 2), ")\n")
cat("  No seasonality:     ", class_none$classification,
    "(strength:", round(class_none$seasonal.strength, 2), ")\n")
```
