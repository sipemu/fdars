...
![Detection rates by seasonal strength](plots/seasonality_detection_comparison.pdf){#fig-detection-rates width=100%}
...
![Precision-Recall curves](plots/seasonality_detection_details.pdf){#fig-pr-curves width=100%}
...
![Detection rates heatmap by seasonal and trend strength](plots/seasonality_detection_trend_heatmaps.pdf){#fig-trend-heatmap width=100%}
...
![FPR when no seasonality is present, across trend strengths](plots/seasonality_detection_trend_pr.pdf){#fig-trend-fpr width=100%}
...
![F1 scores by trend type](plots/seasonality_detection_trend_types_f1.pdf){#fig-trend-types-f1 width=100%}

### FPR by Trend Type

![Example trend functions](plots/seasonality_detection_trend_types_examples.pdf){#fig-trend-examples width=100%}

![FPR across trend types and strengths](plots/seasonality_detection_trend_types_fpr.pdf){#fig-trend-types-fpr width=100%}
...
![Fourier vs P-spline AIC comparison](plots/seasonal_basis_comparison.pdf){#fig-basis-comparison width=100%}
