...
![Detection rates by seasonal strength](plots/seasonality_detection_comparison.pdf){#fig-detection-rates fig-align="center" width=7in height=5in}
...
![Precision-Recall curves](plots/seasonality_detection_details.pdf){#fig-pr-curves fig-align="center" width=7in height=6in}
...
![Detection rates heatmap by seasonal and trend strength](plots/seasonality_detection_trend_heatmaps.pdf){#fig-trend-heatmap fig-align="center" width=7in height=5in}
...
![FPR when no seasonality is present, across trend strengths](plots/seasonality_detection_trend_pr.pdf){#fig-trend-fpr fig-align="center" width=7in height=3in}
...
![F1 scores by trend type](plots/seasonality_detection_trend_types_f1.pdf){#fig-trend-types-f1 fig-align="center" width=7in height=4in}

\newpage

### FPR by Trend Type

![Example trend functions](plots/seasonality_detection_trend_types_examples.pdf){#fig-trend-examples fig-align="center" width=7in height=4in}

![FPR across trend types and strengths](plots/seasonality_detection_trend_types_fpr.pdf){#fig-trend-types-fpr fig-align="center" width=7in height=5in}
...
![Fourier vs P-spline AIC comparison](plots/seasonal_basis_comparison.pdf){#fig-basis-comparison fig-align="center" width=7in height=5in}
