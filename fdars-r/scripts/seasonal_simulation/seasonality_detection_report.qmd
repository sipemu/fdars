...
When secondary seasonality dominates (amplitude 0.7 vs primary 0.3):
- Variance Strength TPR drops to 4%
- Spectral and FFT maintain 100% TPR (detect any periodicity)
- Period specification is critical for Variance method
...
At 10% outliers with magnitude 10× for seasonal strength 0.5:
- Variance TPR: 40%
- Spectral TPR: 52%
- FFT TPR: 66%
- ACF TPR: 2%

**Key finding**: All methods significantly degraded by severe outliers. Pre-filtering recommended.
