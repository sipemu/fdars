...
#' @param metric Metric to use. One of "L2" (default), "L1", or "Linf".
...
#' result <- kmeans.fd(fd, ncl = 2)
#' table(result$cluster, true_cluster)
kmeans.fd <- function(fdataobj, ncl, metric = c("L2", "L1", "Linf"),
  ...
  result <- .Call("wrap__kmeans_fd", fdataobj$data,
